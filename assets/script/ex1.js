    ...
    for (let i = 0, length = radios.length; i < length; i++) {
        if (radios[i].checked) {
            if(radios[i].value == 'c'){
                ...
                gabarito1.textContent = "Gabarito "+radios[i].value+". Resposta errada"
...
botaoQuestao2.addEventListener("click", function(event){
    ...
    for (let i = 0, length = radios.length; i < length; i++) {
        if (radios[i].checked) {
            if(radios[i].value == 'a'){
                gabarito2.textContent = "Gabarito a. A resposta correta é 27. "
                radios[i].parentElement.classList.add("certa")
            }else if(radios[i].value == 'b'){
                gabarito2.textContent = "Gabarito b. A resposta correta é 4."
                radios[i].parentElement.classList.add("certa")
            }else  if(radios[i].value == 'c'){
                gabarito2.textContent = "Gabarito c. A resposta correta é 12."
                radios[i].parentElement.classList.add("certa")
            }else{
                gabarito2.textContent = "Gabarito d. A resposta correta é 60."
                radios[i].parentElement.classList.add("certa")
            }
            break;
        }
    ...
    for (let i = 0, length = radios.length; i < length; i++) {
        if (radios[i].checked) {
            if(radios[i].value == 'b'){
                ...
                gabarito3.textContent = "Gabarito "+radios[i].value+". Resposta errada"
                radios[i].parentElement.classList.add("errada")
            }
            break;
        }
    ...
    for (let i = 0, length = radios.length; i < length; i++) {
        if (radios[i].checked) {
            if(radios[i].value == 'c'){
                ...
                gabarito4.textContent = "Gabarito "+radios[i].value+". Resposta errada"
                radios[i].parentElement.classList.add("errada")
            }
            break;
        }
    ...
    for (let i = 0, length = radios.length; i < length; i++) {
        if (radios[i].checked) {
            if(radios[i].value == 'c'){
                ...
                gabarito5.textContent = "Gabarito "+radios[i].value+". Resposta errada"
                radios[i].parentElement.classList.add("errada")
            }
            break;
        }
...
botaoQuestao6.addEventListener("click", function(event){
    ...
    for (let i = 0, length = radios.length; i < length; i++) {
        if (radios[i].checked) {
            if(radios[i].value == 'e'){
                gabarito6.textContent = "Gabarito e. Resposta certa"
                radios[i].parentElement.classList.add("certa")
            }else{
                gabarito6.textContent = "Gabarito "+radios[i].value+". Resposta errada"
                radios[i].parentElement.classList.add("errada")
            }
            break;
        }
    ...
    for (let i = 0, length = radios.length; i < length; i++) {
        if (radios[i].checked) {
            if(radios[i].value == 'e'){
                ...
                gabarito7.textContent = "Gabarito "+radios[i].value+". Resposta errada"
                radios[i].parentElement.classList.add("errada")
            }
            break;
        }
    ...
    for (let i = 0, length = radios.length; i < length; i++) {
        if (radios[i].checked) {
            if(radios[i].value == 'b'){
                ...
                gabarito8.textContent = "Gabarito "+radios[i].value+". Resposta errada"
                radios[i].parentElement.classList.add("errada")
            }
            break;
        }
...
botaoQuestao9.addEventListener("click", function(event){
    ...
    for (let i = 0, length = radios.length; i < length; i++) {
        if (radios[i].checked) {
            if(radios[i].value == 'b'){
                gabarito9.textContent = "Gabarito b. Resposta certa"
                radios[i].parentElement.classList.add("certa")
            }else{
                gabarito9.textContent = "Gabarito "+radios[i].value+". Resposta errada"
                radios[i].parentElement.classList.add("errada")
            }
            break;
        }
...
botaoQuestao10.addEventListener("click", function(event){
    ...
    for (let i = 0, length = radios.length; i < length; i++) {
        if (radios[i].checked) {
            if(radios[i].value == 'c'){
                gabarito10.textContent = "Gabarito c. Resposta certa"
                radios[i].parentElement.classList.add("certa")
            }else{
                gabarito10.textContent = "Gabarito "+radios[i].value+". Resposta errada"
                radios[i].parentElement.classList.add("errada")
            }
            break;
        }
